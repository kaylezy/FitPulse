  ...
  return (
    ...
    >
      ...
      >
        ...
        <Flex gap="20px">
          <Image w="70px" h="70px" borderRadius="50%" src={kit} />
          <Heading>What is Alopecia and how to prevent it?</Heading>
        </Flex>
        <Flex gap="20px">
          <Image w="70px" h="70px" borderRadius="50%" src={pills} />
      ...
      >
        ...
        <Flex gap="20px">
          <Image w="70px" h="70px" borderRadius="50%" src={vitamina} />
          <Heading>Vitamin A</Heading>
        </Flex>
        <Flex gap="20px">
          <Image w="70px" h="70px" borderRadius="50%" src={vitaminb} />
      ...
      <Stack
        ...
        padding="20px"
      >
        <Image h="150px" w="150px" bg="none" src={rocket} />

        <Heading fontSize="3xl" color="white">
          Upgrade To Pro
        </Heading>
        <Button color="blue.600" fontSize="xl" h="40px" w="130px">
          Get Started
        </Button>
      </Stack>
    </Flex>
